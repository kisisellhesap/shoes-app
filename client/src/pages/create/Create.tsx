...
import type { ShoeData } from "../../utils/types";
    ...
    <div className="max-w-[1000px] mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <Input
          ...
          name="price"
          type="number"
          defaultValue={String(shoeData?.price)}
        />
        <Input
          label="İndirim"
          name="discount"
          type="number"
          defaultValue={String(shoeData?.discount)}
        />
        <Input
          label="Renkler"
          name="color"
        ...
        <div className="flex items-center">
          ...
          <label
            htmlFor="men"
            className="ms-2 me-5 text-sm font-medium text-gray-900"
          >
            Erkek
          </label>
